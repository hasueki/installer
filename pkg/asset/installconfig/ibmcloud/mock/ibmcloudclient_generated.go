...
// GetIAMPolicies mocks base method.
func (m *MockAPI) GetIAMPolicies(ctx context.Context) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIAMPolicies", ctx)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetIAMPolicies indicates an expected call of GetIAMPolicies.
func (mr *MockAPIMockRecorder) GetIAMPolicies(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIAMPolicies", reflect.TypeOf((*MockAPI)(nil).GetIAMPolicies), ctx)
}
...
func (m *MockAPI) GetZoneIDByName(ctx context.Context, name string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) GetZoneIDByName(ctx, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZoneIDByName", reflect.TypeOf((*MockAPI)(nil).GetZoneIDByName), ctx, name)
}
